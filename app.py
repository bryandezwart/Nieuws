...
def build_complete_voicetrack(day_obj: date, day_people: List[BirthdayPerson], news_items: List[NewsItem], news_mode: str) -> str:
    ...
    if news_items:
        if news_mode == "exact":
            lines.append("En ook nog iets opmerkelijks van vandaag.")
        else:
            lines.append("En nog iets opvallends dat de afgelopen dagen in het nieuws opdook.")
