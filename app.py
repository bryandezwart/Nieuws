...
def inject_custom_css():
    st.markdown(
        ...
        div[role="dialog"] [data-baseweb="calendar"] div[aria-selected="true"],
        div[role="dialog"] [data-baseweb="calendar"] div[aria-pressed="true"] {
            background: var(--rm-orange) !important;
            color: #171717 !important;
            border-color: var(--rm-orange) !important;
        }

        /* focus / selected accents */
        *:focus,
        *:focus-visible {
