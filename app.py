...
def inject_custom_css():
    st.markdown(
        ...
        div[data-baseweb="calendar"] *, div[role="dialog"] [data-baseweb="calendar"] * {
        ...
        div[role="dialog"] select, div[role="dialog"] option {
            color: var(--rm-text) !important;
        }
        ...
        *:focus, *:focus-visible {
        ...
        /* Final strong orange checkbox/radio/calendar override */
        input[type="checkbox"],
        ...
        input[type="radio"]:focus {
            accent-color: #F28C18 !important;
            -webkit-accent-color: #F28C18 !important;
        }
        ...
        [role="checkbox"][data-checked="true"],
        ...
        label[data-baseweb="checkbox"] > div:first-child[data-checked="true"] {
