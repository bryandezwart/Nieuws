...
def app():
    st.title("🎙️ Radio dashboard voor voicetracks")
    st.write(
        "Eén Streamlit-pagina voor verjaardagen van JarigVandaag en opmerkelijk nieuws van NU.nl. "
        "Alles staat gegroepeerd, klikbaar en klaar om snel voor te lezen."
    )
